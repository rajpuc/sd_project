			...
			<div class="d-flex flex-column align-content-end">
				<div class="app-auth-body mx-auto">
					...
					<div class="auth-form-container text-start">
						<form class="auth-form login-form" method="post" action="{{ url('store-login') }} "
							...
							<div class="email mb-3">
								<label class="sr-only" for="signin-email">Student Id</label>
								<input id="signin-email" name="stdId" type="number"
									class="form-control signin-email" placeholder="Student Id" required="required">
							</div>
							<!--//form-group-->
